  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9(data-aos="fade-left")
        .titulo-segundo
          h2 Identificar el sistema financiero y gestión del riesgo
        p.mb-4 Apropiar conocimientos del sistema financiero y gestión del riesgo en la identificación de acciones en el campo financiero.
